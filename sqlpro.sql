...
desc orders;
create table order_detials( order_detials_id int not null,
...
(sum(order_details.quantity* pizzas.price))pizza_types.category / (select round(sum(order_detials.quantity* pizzas.price),2) as total_sales 
